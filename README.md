...
<section className="bg-white py-10 px-6 max-w-3xl mx-auto text-gray-800">
 ...
 <li>
      📃 Check out my resume —
      <a
        href="https://drive.google.com/file/d/17GrywwJXx18_kO2Ho_cw4HqVfLnr2gFd/view?usp=sharing"
        target="_blank"
 ...
 <li>
  ...
  <li>
      💬 Ask me about <span className="font-semibold">programming</span>, 
      <span className="font-semibold"> web development</span>
    </li>

 <li>
      ⚡ Reach out to me at — 
      <span className="font-medium ml-1">kawshikks8@gmail.com</span>
    </li>
  </ul>
</section>
